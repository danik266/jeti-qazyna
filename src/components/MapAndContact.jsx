...
const MapAndContact = () => {
    return (
        <section id="contact" className="contact-premium">
            <div className="container">
                <div className="contact-wrap">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <span className="premium-label">БРОНИРОВАНИЕ</span>
                        <h2 className="premium-title">Ждем Вас</h2>
                        <p className="contact-intro">
                            Забронируйте столик или VIP-зал для вашего особого вечера.
                            Мы позаботимся о каждой детали вашего отдыха.
                        </p>
                        ...
                        <div className="contact-list-premium">
                            <div className="c-item-p">
                                ...
                                <div className="c-content-p">
                                    <span className="c-label-p">Адрес</span>
                                    <span className="c-val-p">г. Павлодар, ул. Сулейменова, 45</span>
                                </div>
                            </div>
                            <div className="c-item-p">
                                <div className="c-icon-p"><Phone size={20} /></div>
                                <div className="c-content-p">
                                    <span className="c-label-p">Телефон</span>
                            ...
                            <div className="c-item-p">
                                ...
                                <div className="c-content-p">
                                    <span className="c-label-p">Режим работы</span>
                                    <span className="c-val-p">Ежедневно: 12:00 – 02:00</span>
                                </div>
                            </div>
                        </div>
            ...
            <div className="contact-bg-text">КОНТАКТЫ</div>
        </section>
    );
};
